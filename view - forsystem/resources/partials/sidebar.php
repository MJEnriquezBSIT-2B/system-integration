	...
	<div class="sidebar">
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<!-- faculty only -->
				<li class="nav-item">
					<a href="./../resources/default.php" class="nav-link toggle-icon">
				...
				<li class="nav-item">
					<a href="./../grades/index.php" class="nav-link toggle-icon">
				...
				<li class="nav-item">
					<a href="./../../views/attendance/attendancepage.php" class="nav-link toggle-icon">
				...
				<!-- <li class="nav-item">
					<a href="./../events/index.php" class="nav-link toggle-icon">
